<%-- 
    ...
    Created on      : Jan 8, 2017, 8:17:54 PM
    Author          : Simmigon
                ...
                <ul class="nav navbar-nav side-nav">
					...
					<li>
                        ...
                        <ul id="tenant" class="collapse">
                            <li>
                                <a href="AddNewTenant.html">View Tenant</a>
							 <!-- set inactive -->
                            </li>
                            <li>
                                <a href="AddNewTenant.html"> Add New Tenant</a>
                            </li>
							 <li>
                                <a href="AddNewTenant.html"> Update Tenant</a>
                            </li>
					...
					<li>
                        ...
                        <ul id="client" class="collapse">
                            <li>
                                <a href="AddNewTenant.html">View Tenant Client</a>
							 <!-- set inactive -->
                            </li>
                            <li>
                                <a href="AddNewTenant.html"> Add New Client</a>
                            </li>
							 <li>
                                <a href="AddNewTenant.html"> Update Client</a>
                            </li>
					...
					<li>
                        ...
                        <ul id="admin" class="collapse">
                            <li>
                                <a href="AddNewTenant.html">View Admin</a>
							 <!-- set inactive -->
                            </li>
                            <li>
                                <a href="AddNewTenant.html"> Add New Admin</a>
                            </li>
							 <li>
                                <a href="AddNewTenant.html"> Update Admin</a>
                            </li>
                        </ul>
                    </li>
                    <li>
